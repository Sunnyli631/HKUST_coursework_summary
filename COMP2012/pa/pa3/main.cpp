...
void task3() {
    ...
    //cout << board.getID();
    BoardHashTable::getInstance().updateTable(1281, 3, BoardOptimalMove{1, BoardCoordinate{2, 1}});
    BoardHashTable::getInstance().updateTable(748628229, 3, BoardOptimalMove{10, BoardCoordinate{2, 2}});
